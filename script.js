...
// To present on load setting, a  popular city should hardcoded and for the search term it will replace with user's selected city
function onLoad() {
...
// create holds search list for the selected city.
